...
It is possible to customize the [elementname]#vaadin-upload# in different ways: changing default styles, or providing custom content.
...
The following custom properties are available for styling the components.
