...
| [propertyname]#--vaadin-upload-file-status-icon-complete# | A mixin that is applied to the file complete status icon when file is complete
| [propertyname]#--vaadin-upload-file-status-icon-error# | A mixin that is applied to the file error status icon when error is set
| [propertyname]#--vaadin-upload-file-meta# | A mixin that is applied to the info container
| [propertyname]#--vaadin-upload-file-meta-complete# | A mixin that is applied to the info container when file is complete
| [propertyname]#--vaadin-upload-file-meta-error# | A mixin that is applied to the info container when error is set
