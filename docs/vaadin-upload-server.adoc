...
Communication between [elementname]#vaadin-upload# element and server-side can be completely configured using element properties or attributes, and events.
